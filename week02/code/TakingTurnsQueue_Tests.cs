...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Initially the queue was using Insert(0, person) in PersonQueue, which reversed order.
    ...
    // Defect(s) Found: Originally PersonQueue.Enqueue used Insert(0, person) adding to the front. Queue order was reversed. Fixed by using _queue.Add(person).
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found:  Turns logic did not handle 0 (infinite) correctly. Fixed GetNextPerson() to keep Turns <= 0 persons in queue.
    ...
    // Defect(s) Found: Negative Turns treated incorrectly. Fixed GetNextPerson() to treat Turns <= 0 as infinite.
